...
extern void basemul_asm(int16_t *, const int16_t *, const int16_t *, const uint32_t *);
/*************************************************
* Name:        poly_basemul
*
...
extern void basemul_asm_acc(int16_t *, const int16_t *, const int16_t *, const uint32_t *);
/*************************************************
