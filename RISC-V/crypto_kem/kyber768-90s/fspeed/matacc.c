...
extern void doublebasemul_asm_cache_16_32(int32_t r_tmp_ptr[4], int16_t bprimeptr[2], int16_t bptr[4], int16_t cptr[4], int32_t zeta);
extern void doublebasemul_asm_acc_cache_32_32(int32_t r_tmp_ptr[4], int16_t bprimeptr[2], int16_t bptr[4], int16_t cptr[4], int32_t zeta);
extern void doublebasemul_asm_acc_cache_32_16(int16_t r[4], int32_t r_tmp_ptr[4], int16_t bprimeptr[2], int16_t b_ptr[4], int16_t c_ptr[4], int32_t zetas);

extern void doublebasemul_asm_opt_16_32(int32_t r_tmp_ptr[4], int16_t bprimeptr[2], int16_t bptr[4], int16_t cptr[4]);
extern void doublebasemul_asm_acc_opt_32_32(int32_t r_tmp_ptr[4], int16_t bprimeptr[2], int16_t bptr[4], int16_t cptr[4]);
extern void doublebasemul_asm_acc_opt_32_16(int16_t r[4], int32_t r_tmp_ptr[4], int16_t bprimeptr[2], int16_t bptr[4], int16_t cptr[4]);

void matacc_cache_32(int16_t *r, int32_t *r_tmp, int16_t *b, int16_t c[4], unsigned char buf[XOF_BLOCKBYTES + 2], const uint32_t zetas[64], xof_state *state, int16_t *bprimeptr, int type)
{
	...
	while (ctr < KYBER_N / 4)
	{
		...
		if (val0 < KYBER_Q)
		{
			...
			{
				if(type==0){
					doublebasemul_asm_cache_16_32(&r_tmp[4 * ctr], &bprimeptr[2 * ctr], &b[4 * ctr], c, zetas[ctr]);
				}
				else if(type==1){
					doublebasemul_asm_acc_cache_32_32(&r_tmp[4 * ctr], &bprimeptr[2 * ctr], &b[4 * ctr], c, zetas[ctr]);
				}
				else{
					doublebasemul_asm_acc_cache_32_16(&r[4 * ctr], &r_tmp[4 * ctr], &bprimeptr[2 * ctr], &b[4 * ctr], c, zetas[ctr]);
				}
				ctr++;
				k = 0;
			}
...
void matacc_opt_32(int16_t* r, int32_t *r_tmp, int16_t *b, int16_t c[4], unsigned char buf[XOF_BLOCKBYTES + 2], xof_state *state, int16_t *bprimeptr, int type)
{
	unsigned int buflen, off;
	unsigned int ctr, pos, k, l;
	uint16_t val0, val1;
 ...
 **************************************************/
void matacc_cache32(poly *r, int32_t *r_tmp, polyvec *b, polyvec_half *b_prime, unsigned char i, const unsigned char *seed, int transposed)
{
 ...
 *              - int transposed:             boolean indicatin whether A or A^T is generated
 **************************************************/
void matacc_opt32(poly *r, int32_t* r_tmp, polyvec *b, polyvec_half *b_prime, unsigned char i, const unsigned char *seed, int transposed)
{
	unsigned char buf[XOF_BLOCKBYTES + 2];
	xof_state state;
	int16_t c[4];
